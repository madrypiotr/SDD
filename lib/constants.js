...
TXV = {
    ...
    YOUR_APPLICATION_FORM_WIL_BE_WAITING: "Twój wniosek będzie oczekiwał (maksymalnie ",
    DAYS_FOR_APPROVAL_OF_THE_TOTAL_MEMBERS: " dni) na akceptację ogółu Członków Organizacji ",
    AFTER_A_POSITIVE_EXAMINATION_WILL_RECIVE_INFO: ". Po pozytywnym rozpatrzeniu otrzymasz informację w wiadomości na ",
    YOU_WILL_RECEIVE_A_LINK_TO_ACTIVATE_YOUR: ", w której otrzymasz link aktywujący Twoje ",
    AFTER_ACCEPTING_THE_PERSON_THAT_YOU_INDICATED_WILL_RECEIVE_EMAIL_AT: ". Po pozytywnym rozpatrzeniu, Osoba, którą wskazałeś otrzyma wiadomość na adres ",
    WHICH_WILL_RECEIVE_A_LINK_ON_BELONGING_TO_THEORGANIZATION_AS_A: ", w której otrzyma link, gdzie będzie mogła potwierdzić/odrzucić chęć przynależności do oragnizacji jako ",
    X: "",
    X: "",
    X: "",
    X: "",
